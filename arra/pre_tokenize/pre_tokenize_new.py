...
from data.item_processor_new import FlexARItemProcessor
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--in_filename",
        default="./datasets/MIMIC-CXR/xray_impression_conversion/impression_conversion_p18.json",
        type=str,
    )
    parser.add_argument(
        "--out_dir",
        default="./pre_tokenization/mimic_impression_768/p18",
        type=str,
    )
    ...
    for i in range(start_idx, end_idx):
        ...
        try:
            ...
            record = {"file": pkl_path, "len": len(tokens), "id": i, "image_path": ori_contents[i]["image"]}
