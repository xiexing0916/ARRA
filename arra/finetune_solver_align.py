...
from model.modeling_xllmx_chameleon_align import ChameleonXLLMXForConditionalGeneration
from model import ChameleonXLLMXConfig
from xllmx.data.item_processor_new import ItemProcessorBase
from xllmx.solvers.finetune.finetune_align import FinetuneSolverBase
...
class ItemProcessor(ItemProcessorBase):
    def process_item(self, data_item: dict, training_mode=False):
        ...
        if "token" in data_item and "label" in data_item:
            ...
            assert "file", "image_path" in data_item
            image_path = data_item["image_path"][0]
            # print(image_path)
        ...
        return tokens, labels, image_path
...
class Solver(FinetuneSolverBase):
    ...
    def _make_and_save_starting_point(self, save_path: str) -> None:
        ...
        pretrained_name = {
            "7B": "/data/xxing/Lumina-mGPT/Alpha-VLLM/Lumina-mGPT-7B-512",
        ...
        # model.resize_token_embeddings(65551)
