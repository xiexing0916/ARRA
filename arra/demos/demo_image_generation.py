...
def model_worker(
    ...
    while True:
        ...
        try:
            ...
            # prompt = f"Generate an image based on the following report: {prompt}"
            print(prompt)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_path", type=str, default="./lumina_mgpt/output/7B-xray-brats-tianchong/epoch1", required=False, help="Path to the model checkpoints.")
    parser.add_argument(
        "--precision",
        type=str,
        choices=["fp16", "bf16"],
