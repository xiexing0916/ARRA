...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_path", type=str, default="./Lumina-mGPT/lumina_mgpt/output/7B-xray-brats-tumor-tianchong/epoch1", help="Path to the model checkpoints.")
    parser.add_argument(
        "--precision",
        type=str,
        choices=["fp16", "bf16"],
