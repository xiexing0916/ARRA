...
class FlexARInferenceSolver:
    ...
    def __init__(self, model_path, precision, target_size=512, adapter_path=None):
        self.dtype = {"bf16": torch.bfloat16, "fp16": torch.float16, "fp32": torch.float32}[precision]

        self.base_model = ChameleonForConditionalGeneration.from_pretrained(
            model_path,
        ...
        self.item_processor = FlexARItemProcessor(target_size=target_size, tokenizer="/data/xxing/Lumina-mGPT/Alpha-VLLM/Lumina-mGPT-7B-768")
