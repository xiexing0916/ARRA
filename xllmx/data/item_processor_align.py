...
from xllmx.model.tokenizer_align import Tokenizer
...
class MMConvItemProcessor(ItemProcessorBase):
    ...
    def process_item(self, data_item: dict, training_mode=False) -> Tuple[List, List]:
        # data_item['conversations'][1]['value'] = '<reserved08795>' + data_item['conversations'][1]['value']
        # print(data_item['conversations'][1]['value'])
        # data_item['conversations'][0]['value'] += ' <reserved08795>'
        ...
        #     "Edema": "<EDEMA>",
        #     "Enlarged Cardiomediastinum": "<ENLARCARD>",
        #     "Fracture": "<FRACT>",
        #     "Lung Lesion": "<LUNGLES>",
        #     "Lung Opacity": "<LUNGOPA>",
        #     "No Finding": "<NOFIND>",
        #     "Pleural Effusion": "<PLEEFFU>",
        #     "Pleural Other": "<PLEOYH>",
        #     "Pneumonia": "<PNEUMON>",
        #     "Pneumothorax": "<PNEUMOTH>",
        #     "Support Devices": "<SUPPDEVICE>",
        # }  # 14 TYPE Lesion
        # for lesion, token in lesion_tokens.items():
        #     conversation = conversation.replace(lesion, token)
        #     for i, p in enumerate(pieces):
        #         p["data"] = p["data"].replace(lesion, token)
        # additional_tokens = list(lesion_tokens.values())
        # self.tokenizer.add_tokens(additional_tokens)

        # id1 = self.tokenizer.get_token_id("<ATELE>")
        # id2 = self.tokenizer.get_token_id("<CARDIO>")
        # id3 = self.tokenizer.get_token_id("<CONSOL>")
        # id4 = self.tokenizer.get_token_id("<EDEMA>")
